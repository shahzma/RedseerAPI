...
class CalculatedParamFn:
    ...
    def calc_script_eb2bGrocery(self, pl_id, sd, ed):
        ...
        calc_dict[3172] = calc_dict[2658] + calc_dict[2659] + \
            calc_dict[2660] + calc_dict[2661] + calc_dict[2662]
    ...
    def calc_script_usedCars(self, pl_id, sd, ed):
        ...
        try:
            ...
            calc_dict[1202] = d[1193] - (d[1194] + d[1195] + d[1196] +
                                         d[1197] + d[1198] + d[1199] + d[1200] + d[1201])
            calc_dict[1213] = d[1214] - (d[1205] + d[1206] + d[1207] +
                                         d[1208] + d[1209] + d[1210] + d[1211] + d[1212])
            calc_dict[1217] = d[1192] + d[1193] - d[1214]
            calc_dict[1228] = d[1219] - (d[1220] + d[1221] + d[1222] +
                                         d[1223] + d[1224] + d[1225] + d[1226] + d[1227])
        ...
        try:
            calc_dict[1252] = d[1747] - (d[1184] + d[1185] + d[1186] +
                                         d[1187] + d[1188] + d[1189] + d[1190] + d[1191])
        except:
            pass
    ...
    def calc_script_meatCore(self, pl_id, sd, ed):
        ...
        try:
            ...
            pass
        calc_dict[1444] = 100 - (d[1439] + d[1440] +
                                 d[1441] + d[1442] + d[1443])
        calc_dict[1450] = 100 - (d[1445] + d[1446] +
                                 d[1447] + d[1448] + d[1449])
        calc_dict[1457] = 100 - (d[1452] + d[1453] +
                                 d[1454] + d[1455] + d[1456])
        calc_dict[1464] = 100 - (d[1459] + d[1460] +
                                 d[1461] + d[1462] + d[1463])
        calc_dict[1471] = 100 - (d[1466] + d[1467] +
                                 d[1468] + d[1469] + d[1470])
        calc_dict[1478] = 100 - (d[1473] + d[1474] +
                                 d[1475] + d[1476] + d[1477])
        calc_dict[1485] = 100 - (d[1480] + d[1481] +
                                 d[1482] + d[1483] + d[1484])
    ...
    def calc_script_meatMarketPlace(self, pl_id, sd, ed):
        ...
        try:
            calc_dict[1501] = (d[1499] * d[1500] *
                               self.month_range(sd)) / 10000
        except:
            pass
        calc_dict[1507] = 100 - (d[1502] + d[1503] +
                                 d[1504] + d[1505] + d[1506])
        calc_dict[1513] = 100 - (d[1508] + d[1509] +
                                 d[1510] + d[1511] + d[1512])
    ...
    def calc_script_d2c(self, pl_id, sd, ed):
        ...
        try:
            calc_dict[460] = calc_dict[461] + \
                calc_dict[462] + calc_dict[463] + calc_dict[464]
        except:
            pass
    ...
    def calc_script_horizontals(self, pl_id, sd, ed):
        ...
        try:
            ...
            pass
        try:
            calc_dict[1418] = calc_dict[243] - \
                (d[1413] + d[1414] + d[1415] + d[1416] + d[1417])
        except:
            pass
        try:
    ...
    def calc_script_ehealth(self, pl_id, sd, ed):
        ...
        try:
            calc_dict[1762] = 100 - \
                (d[1757] + d[1758] + d[1759] + d[1760] + d[1761])
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            calc_dict[1885] = (calc_dict[1871] + d[93] +
                               calc_dict[1879]) * 7 - calc_dict[1880]
        except:
            pass
        try:
            ...
            pass
        try:
            calc_dict[1893] = calc_dict[1887] - \
                (d[1888] + d[1889] + d[1890] + d[1891] + d[1892])
        except:
            pass
    ...
    def calc_script_foodtech(self, pl_id, sd, ed):
        ...
        try:
            ...
            pass
        try:
            calc_dict[361] = ((d[362]*d[337])+(d[338]*d[363])+(d[364]*d[339]) +
                              (d[365]*calc_dict[340]))/(d[337]+d[338]+d[339]+calc_dict[340])
        except:
            pass
        try:
            calc_dict[366] = ((d[367]*d[337])+(d[338]*d[368])+(d[369]*d[339]) +
                              (d[370]*calc_dict[340]))/(d[337]+d[338]+d[339]+calc_dict[340])
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            calc_dict[375] = calc_dict[371] - \
                (calc_dict[372]+calc_dict[373]+calc_dict[374])
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            calc_dict[1630] = calc_dict[371] - \
                (calc_dict[1627]+calc_dict[1628]+calc_dict[1629])
        except:
            pass
        try:
