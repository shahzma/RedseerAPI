...
class CalculatedParamOTTVidioFn:
    global max_par
    def __init__(self):
    ...
    def InsertORUpdate(dff):
        ...
        try:
            ...
            db.commit()
            print("OTTVideo Script:- InsertORUpdate Done")
            cur.close()
            db.close()
        except Exception as e:
            print("OTTVideo Script:- Insert or Update error - ",e)
    ...
    def par_val_dict(pl_id, sd, ed):
        try:
            ...
            print("OTTVideo Script: par_val_dict error - ",e)
    ...
    def upload_resumable2(self):
        try:
            ...
            print("OTTVideo Script: upload_resumable2 error - ",e)
    ...
    def WA_Calc(self,pl,sd,ed,rep_ver_id):
        try:
            ...
            df=pd.read_excel(yls,"OTT Video", header=None, index_col=False)
            required_df=[]
            ...
            cur.close()
            db.close()
            print("OTTVideo Script: WA_Calc completed")
        except Exception as e:
            print("OTTVideo Script: WA error - ",e)

    
    def calc_script_video(self, pl_id, sd, ed,pr_sd,pr_ed,rep_ver_id):
        try:
            calc_dict = {}
            # print(pl_id)
            try:
            ...
            try:
                ...
                pass
            try:
                calc_dict["203:Others (%)"]=100-d["199:Daily Soaps (%)"]-d["200:Movies (%)"]-d["201:TV Series (%)"]-d["202:Originals (%)"]
            except:
                pass
            try:
            ...
            try:
                ...
                pass
            try:
                calc_dict["93:Subscription Revenue (USD Mn)"]=d["5:No of Paid Users (Mn)"]*d["22:ARPU (USD)"]
            except:
                pass
            try:
                calc_dict["75:Overall Revenue (USD Mn)"]=d["18:Ad Revenue (USD Mn)"]+calc_dict["93:Subscription Revenue (USD Mn)"]
            except:
                pass
            try:
            ...
            self.InsertORUpdate(required_df)
            print("OTTVideo Script: calc_script_video completed")
        except Exception as e:
            print("OTTVideo Script:- calc script error - ",e)
    ...
    def report_version_id(self, rep_ver_id, callback):
        try:
            ...
            print(p_sd)
            self.calc_script_video(pl,sd,ed,str(p_sd),str(p_ed),rep_ver_id)
            self.WA_Calc(pl,sd,ed,rep_ver_id)
            cur.close()
            db.close()
            print("OTTVideo Script:- report_version_id finished")
            callback()
        except Exception as e:
            print("OTTVideo report_version_id error - ",e)
